# Write music and convert to mdv format.

We now need a route to create music and convert it into a format which is easy for chuck to read back.

Watch the week 8 abc video starting 33mins 12 seconds in skipping the details of the ABC file format just to see how to create and use the format.

## Producing ABC Format

Download and run MuseScore as a music editor.

![musescore](images/musescore.png)

There are tutorials which explain how to enter notes in musical score.
Version 3.6 is current and I am looking forward to the release of version 4 soon. 

![export](images/export.png)

Write a simple tune on a single line of music.  Do not use any chords or any fancy features such as 1st and secont time bars.  No lyrics or chord symbols.  My code to read abc files is pretty accurate, but it can't cope with embellishments.

Export to the oldest version of musicXML which muse score will allow, this makes the simplest file format.

![xml](images/xml.png)

Even so the music xml format is too complex.  It contains information for typesetting as well as the musical content.

![convert](images/convert.png)

Present your xml file to the converter at the [wim.vree.org](https://wim.vree.org/js/xml2abc-js.html)

This is a fairly plain looking website, but it does the job.

![converted](images/converted.png)

The converted text may still contain some formatting text that we don't want.  Use the text editor on the site to remove all lines with %% on and also any text between the key signature line K: and the start of the music.

![store](images/store.png)

On your folder you should have the program abcConverter.ck and two subfolders, abc and mdv.

When the file has been tidied, store it as a .txt file in the abc folder.

You can inspect the demo abc files already in the folder.  The file should be simple and human readable.
...
The filenames listed here are just default values, they will be replaced by the filename you pass as an argument when you run the program.
