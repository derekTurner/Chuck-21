...
function void track2 (Event start){

    "../audio/" => string samplepath;
    ["snare_01.wav"] @=> string samplefiles[];
    samplefiles << "snare_02.wav";
    samplefiles << "snare_03.wav";
    SndBuf buffers[samplefiles.cap()];
    ...
    while( true )
    {
        ...
        normRand(20, 0.2, 1) => buffers[buf].rate;
        normRand(20, 50, 2000)::ms => now;
    }
